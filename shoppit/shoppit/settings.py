...
SECRET_KEY = 'django-insecure-l^xxso3jc*cej)0i%j#bfit(^m8tm=_s187l@@0s^4e8v1fk!%'
...
# # Razorpay Test Keys
# RAZORPAY_KEY_ID = "rzp_test_VyThAPd2W7VJir"
# RAZORPAY_KEY_SECRET = "XRcSu1gEJcRZpTigbhudFHh2"
